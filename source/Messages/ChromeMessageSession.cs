...
namespace MasterDevs.ChromeDevTools.Messages {
	public class ChromeMessageSession : IChromeSession
    {
        ...
        private Action<object> finalHandler = null;

        public ChromeMessageSession(string endpoint, ICommandFactory commandFactory, ICommandResponseFactory responseFactory, IEventFactory eventFactory)
        {
            _endpoint = endpoint;
        ...
        public void SubscribeFinal(Action<object> finalHandler) {
        ...
        private void WebSocket_DataReceived(object sender, DataReceivedEventArgs e)
        {
            ...
            if (null != finalHandler) {
                var dynObj = CreateFrom(e.Data);
                finalHandler(dynObj);
            }
        }

        private object CreateFrom(byte[] data) {
            throw new NotImplementedException();
        }

        private object CreateFrom(string dataText) {
            var jObject = JObject.Parse(dataText);
            return jObject.ToObject(typeof(object));
        }
        ...
        private void WebSocket_MessageReceived(object sender, MessageReceivedEventArgs e)
        {
            ...
            if (null != finalHandler) {
                var dynObj = CreateFrom(e.Message);
                finalHandler(dynObj);
            }
        }
